...
def render():
    ...
    stories_html += f'<div class="delta-story"><div class="delta-story-ring"><div class="delta-story-inner">{iniciais}</div></div><div class="delta-story-label">Você</div></div>'
    
    for tema in temas:
        stories_html += f'<div class="delta-story"><div class="delta-story-ring"><div class="delta-story-inner">{emoji_tema(tema.split()[0])}</div></div><div class="delta-story-label">{truncar(tema, 14)}</div></div>'
