...
Centraliza os cursos exibidos no cadastro do aluno. Cada curso traz
metadados que alimentam a personalização (descrição e temas de
Cálculo I que dialogam com a área).
"""
...
CURSOS = [
    ...
    },
    {
        ...
        "temas_calculo": ["Limites", "Derivadas", "Integrais", "Continuidade"],
    },
    {
        "id": 8,
        "nome": "Física",
...
def listar_nomes_cursos():
    """Retorna apenas os nomes dos cursos (para selectbox)."""
    return [curso["nome"] for curso in CURSOS]


# Alias mantido para compatibilidade com chamadas antigas
def obter_nomes_cursos():
    """Alias de listar_nomes_cursos (compatibilidade)."""
    return listar_nomes_cursos()
